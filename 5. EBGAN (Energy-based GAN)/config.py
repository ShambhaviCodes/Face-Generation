...
parser.add_argument('--margin', type=int, default=20, help='margin for Celeb A dataset')
parser.add_argument('--limit', type=int, default=1e5, help='the number of images to be generated for inference')
parser.add_argument('--lambda_pt', type=float, default=0.1, help='the constant for pulling ratio')
